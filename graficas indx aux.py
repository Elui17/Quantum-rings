...
table_files = [
    ("IndiceNOSOI_impureza_B_0_P_10_T_0.csv", "IndiceNOSOI_Sin_impureza_B_0_P_10_T_0.csv"),
    ("IndiceSOI_impureza_B_0_P_10_T_0.csv", "IndiceSOI_Sin_impureza_B_0_P_10_T_0.csv"),
    ("IndiceNOSOI_impureza_B_0_P_10_T_300.csv", "IndiceNOSOI_impureza_B_0_P_10_T_300.csv"),
    ("IndiceSOI_impureza_B_0_P_10_T_300.csv", "IndiceSOI_Sin_impureza_B_0_P_10_T_300.csv")
]
...
def create_image(
    ...
    # Guardar la figura
    filename = f"Indiceimagen_{image_index}.png"
...
table_files_2 = [
    ("IndiceNOSOI_impureza_B_10_P_10_T_0.csv", "IndiceNOSOI_Sin_impureza_B_10_P_10_T_0.csv"),
    ("IndiceSOI_impureza_B_10_P_10_T_0.csv", "IndiceSOI_Sin_impureza_B_10_P_10_T_0.csv"),
    ("IndiceNOSOI_impureza_B_10_P_10_T_300.csv", "NOSOI_Sin_impureza_B_10_P_10_T_300.csv"),
    ("IndiceSOI_impureza_B_10_P_10_T_300.csv", "IndiceSOI_Sin_impureza_B_10_P_10_T_300.csv")
]
...
create_image("IndiceB_10_P_10", table_files_2, custom_legend_names_2, xlim=(-1, 50), ylim=(0, 5), spine_width=2, x_step=10, y_step=1)

table_files_3 = [
    ("IndiceNOSOI_impureza_B_0_P_15_T_0.csv", "IndiceNOSOI_Sin_impureza_B_0_P_15_T_0.csv"),
    ("IndiceSOI_impureza_B_0_P_15_T_0.csv", "IndiceSOI_Sin_impureza_B_0_P_15_T_0.csv"),
    ("IndiceNOSOI_impureza_B_0_P_15_T_300.csv", "IndiceNOSOI_Sin_impureza_B_0_P_15_T_300.csv"),
    ("IndiceSOI_impureza_B_0_P_15_T_300.csv", "IndiceSOI_Sin_impureza_B_0_P_15_T_300.csv")
]
...
create_image("IndiceB_0_P_15", table_files_3, custom_legend_names_3, xlim=(-1, 50), ylim=(0, 5), x_step=10, y_step=1)

table_files_4 = [
    ("IndiceNOSOI_impureza_B_10_P_15_T_0.csv", "IndiceNOSOI_Sin_impureza_B_10_P_15_T_0.csv"),
    ("IndiceSOI_impureza_B_10_P_15_T_0.csv", "IndiceSOI_Sin_impureza_B_10_P_15_T_0.csv"),
    ("IndiceNOSOI_impureza_B_10_P_15_T_300.csv", "IndiceNOSOI_Sin_impureza_B_10_P_15_T_300.csv"),
    ("IndiceSOI_impureza_B_10_P_15_T_300.csv", "IndiceSOI_Sin_impureza_B_10_P_15_T_300.csv")
]
...
create_image("IndiceB_10_P_15", table_files_4, custom_legend_names_4, xlim=(-1, 50), ylim=(0, 5), x_step=10, y_step=1)
